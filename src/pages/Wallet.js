...
function Wallet() {
    ...
    const [initiateRequestURL, setInitiateRequestURL] = useState('http://localhost:4010/request?student_id=400000002&batch=first&redirect_uri=https://digitalcredentials.github.io/cred-wallet-emulator')
